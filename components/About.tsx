                ...
                <div className="space-y-6">
                  {experiences.map((exp, index) => (
                    <div key={index} className="group flex flex-col md:flex-row md:items-baseline justify-between border-b border-white/5 pb-4 last:border-0 last:pb-0">
                      ...
                      <span className="text-secondary/50 text-xs font-light tracking-wide font-mono group-hover:text-white transition-colors duration-300">{exp.period}</span>
                    </div>
                  ))}
                </div>
